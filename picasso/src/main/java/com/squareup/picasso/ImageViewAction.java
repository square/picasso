...
class ImageViewAction extends Action<ImageView> {
  ...
  ImageViewAction(Picasso picasso, ImageView imageView, Request data, boolean skipCache,
      boolean localOnly, boolean noFade, int errorResId, Drawable errorDrawable,
      String key, Callback callback) {
    super(picasso, imageView, data, skipCache, localOnly, noFade, errorResId, errorDrawable, key);
