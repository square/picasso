...
public class WeakReferencesCache implements Cache {
  ...
  @Override public int size() {
    //We can not know the actual size, because we can don't know when an image has been
    //purged.
    return -1;
  }

  @Override public int maxSize() {
    //We can not know the max size, The garbage collector would define it.
    return -1;
  }
   ...
   * have changed it.
   */
  @TestOnly final void emulateGarbageRecollection() {
