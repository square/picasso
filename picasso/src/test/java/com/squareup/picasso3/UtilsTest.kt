...
class UtilsTest {
  @Test fun matchingRequestsHaveSameKey() {
    ...
    val t1 = TestTransformation("foo")
    val t2 = TestTransformation("foo")
    ...
    val t3 = TestTransformation("foo")
    val t4 = TestTransformation("bar")
    ...
    val t5 = TestTransformation("foo")
    val t6 = TestTransformation("bar")
