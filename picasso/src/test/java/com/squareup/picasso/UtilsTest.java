...
public class UtilsTest {
  ...
  @Test public void matchingRequestsHaveSameKey() {
    Request r1 = new Request(picasso, URL, 0, null, null, NONE, null, 0, false, null);
    Request r2 = new Request(picasso, URL, 0, null, null, NONE, null, 0, false, null);
    ...
    Request single1 = new Request(picasso, URL, 0, null, null, t1, null, 0, false, null);
    List<Transformation> t2 = new ArrayList<Transformation>();
    t2.add(new TestTransformation("foo", null));
    Request single2 = new Request(picasso, URL, 0, null, null, t2, null, 0, false, null);
    ...
    Request double1 = new Request(picasso, URL, 0, null, null, t3, null, 0, false, null);
    ...
    Request double2 = new Request(picasso, URL, 0, null, null, t4, null, 0, false, null);
    ...
    Request order1 = new Request(picasso, URL, 0, null, null, t5, null, 0, false, null);
    Request order2 = new Request(picasso, URL, 0, null, null, t6, null, 0, false, null);
