...
public class UtilsTest {
  ...
  @Test public void matchingRequestsHaveSameKey() {
    Request r1 = new Request(picasso, URL, null, null, null, false, false, 0, null);
    Request r2 = new Request(picasso, URL, null, null, null, false, false, 0, null);
    ...
    Request single1 = new Request(picasso, URL, null, null, t1, false, false, 0, null);
    List<Transformation> t2 = new ArrayList<Transformation>();
    t2.add(new TestTransformation("foo", null));
    Request single2 = new Request(picasso, URL, null, null, t2, false, false, 0, null);
    ...
    Request double1 = new Request(picasso, URL, null, null, t3, false, false, 0, null);
    ...
    Request double2 = new Request(picasso, URL, null, null, t4, false, false, 0, null);
    ...
    Request order1 = new Request(picasso, URL, null, null, t5, false, false, 0, null);
    Request order2 = new Request(picasso, URL, null, null, t6, false, false, 0, null);
